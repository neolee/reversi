...
class EngineConfigDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        self.params_form.setContentsMargins(15, 20, 15, 15)
        self.params_form.setSpacing(12)
    ...
    def load_config(self, color: str, is_human: bool, config: Dict[str, Any]):
        ...
        if is_human:
            ...
            self.params_group.setEnabled(self.enabled_checkbox.isChecked())
            self.engine_combo.setEnabled(self.enabled_checkbox.isChecked())
        else:
    ...
    def _handle_enabled_toggled(self, checked):
        ...
        self.engine_combo.setEnabled(checked)
